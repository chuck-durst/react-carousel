...
var Slider = function (_React$PureComponent) {
  ...
  function Slider(props) {
    ...
    _this.handleSlideTouchMove = function (e, slideIndex) {
      if (_this.slideOnMobile === true) {
        ...
        if (_this.prevDragSlide && _this.nextDragSlide && _this.draggedSlide) {
          ...
          var dragDistance = e.targetTouches[0].pageX - _this.pageX || (slideIndex === 0 ? -1 : 1);
    ...
    _this.handleSlideTouchEnd = function () {

      // Check if all the required stuff exists
      if (_this.prevDragSlide && _this.draggedSlide && _this.nextDragSlide && _this.dragDistance && _this.slideOnMobile) {
  ...
  (0, _createClass3.default)(Slider, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.props.showDots === true && _react2.default.createElement(_Pagination2.default, {
        ...
        this.props.slides.map(function (slide, key) {
          return _react2.default.createElement(_Slide2.default, {
            ...
            onTouchMove: _this2.handleSlideTouchMove,
            onTouchEnd: _this2.handleSlideTouchEnd,
