...
var Slide = (_temp = _class = function (_React$Component) {
  ...
  this._handleTouchMove = function (e) {
    return _this3.props.onSlideMove(e.targetTouches[0].pageX, _this3.props.index);
  };

  this._handleDragStart = function (e) {
    window.addEventListener('mouseup', _this3._handleDragStop);
    window.addEventListener('mousemove', _this3._handleMouseMove);
  };

  this._handleDragStop = function (e) {
    window.removeEventListener('mouseup', _this3._handleDragStop);
    window.removeEventListener('mousemove', _this3._handleMouseMove);
    _this3.props.onSlideMoveEnd();
  };

  this._handleMouseMove = function (e) {
    _this3.props.onSlideMove(e.pageX, _this3.props.index);
  };
